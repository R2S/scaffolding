...
public enum PositionButton {
	DATATABLE_LINE("datatable-line", TypeActionScaffold.LIST), DATATABLE_TOP("datatable-top",
			TypeActionScaffold.LIST), INSERT_TOP("insert-top", TypeActionScaffold.CREATE), INSERT_BOTTON(
					"insert-button", TypeActionScaffold.CREATE), UPDATE_TOP("update-top",
							TypeActionScaffold.EDIT), UPDATE_BOTTON("update-botton", TypeActionScaffold.EDIT), SHOW_TOP(
									"show-top",
									TypeActionScaffold.VIEW), SHOW_BOTTON("show-botton", TypeActionScaffold.VIEW);
	...
	static PositionButton getPosition(String positionA) {
